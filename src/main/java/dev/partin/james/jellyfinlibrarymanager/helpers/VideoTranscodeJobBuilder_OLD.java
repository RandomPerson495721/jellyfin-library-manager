...
@Getter
public class VideoTranscodeJobBuilder_OLD {
    ...
    public VideoTranscodeJobBuilder_OLD(TranscodeConfiguration transcodeConfiguration, JobDefinition jobDefinition) throws IOException {
